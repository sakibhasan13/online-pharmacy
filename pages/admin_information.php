    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="admin_information.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5" id="product" role="tabpanel">
                    <h3 class="fs-4 mb-3">Admin Information</h3>
                    <?php
                                      include('../config/dbconn.php');
                                      ...
                                      $result = mysqli_query($connection,"SELECT * FROM `login` WHERE usertype='admin' ORDER BY 'supp_name' ASC");
                                      ?>  
                    <div class="col">
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                echo "<td><a href=\"admin_account_update.php?user_id=$res[id]\">Edit</a> | <a href=\"admin_account_delete.php?user_id=$res[id]
