    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="activity.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="row my-5" id="product" role="tabpanel">
                    <h3 class="fs-4 mb-3" style="text-align:center;">Activity Information</h3>
                    <?php
                    include('../config/dbconn.php');
                    ?> 
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover" style="width:80%;text-align:center;margin-left:110px">
                        <?php
                                                $query=mysqli_query($connection,"SELECT * FROM logs NATURAL JOIN login ORDER BY date DESC")or die(mysqli_error());
                                                while($row=mysqli_fetch_array($query)){ 
                                            ?>
                                          <tr>
                                            <td class="activity_text"><?php echo $row['name']." ".$row['action']." last ".$row['date'];?></td>
                                          </tr>               
                                                <?php
                                              }
                                            ?>         
