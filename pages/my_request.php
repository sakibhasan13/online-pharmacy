...
<body>
            ...
            <li class="item"><a href="user_index.php">HOME</a></li>
                ...
                <i class="fas fa-user me-2"></i></a>
                            ...
                            <ul>
                                ...
                                <li><a href="user_blood_request.php">My Request</a></li>
    ...
    <div class="button">
    <a class="btn btn-success btn-round" style="background-color:#FF6347;margin-right:20px;" href="request_form.php"><i class="now-ui-icons ui-1_simple-add"></i> Create request</a>
    <a class="btn btn-success btn-round" style="background-color:#FF6347;" href="donation.php"><i class="now-ui-icons ui-1_simple-add"></i> Donate Blood</a>
    
    </div>
    
                <div class="row g-3 my-2">
                <div class="row my-5" id="product" role="tabpanel">
                    <h3 class="fs-4 mb-3" style="text-align:center;padding-bottom:30px;text-transform:uppercase;">My Blood Request</h3>
                    <?php
                                      include('../config/dbconn.php');
                                      $result = mysqli_query($connection,"SELECT * FROM `requester` WHERE user_id=$_SESSION[id]");
                                      ?>  
                    <div class="col">
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                echo "<td><a class='btn btn-danger' style='margin:0;' href=\"delete_request.php?requester_id=$res[requester_id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
