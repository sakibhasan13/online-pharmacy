    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="product_information.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5" id="product" role="tabpanel">
                    <h3 class="fs-4 mb-3">Product Information</h3>
                    <?php
                                      include('../config/dbconn.php');
                                          ...
                                          if($result){
                                            while($res = mysqli_fetch_array($result)) {     
                                              echo "<tr>";
                                                ...
                                                $prod_qty=$res['product_qty'];
                                                
                                                if ($prod_qty<=10){
                                                ?>
                                                 <td><span style="color:red;"><?php echo $res['product_qty'];?></span></td>  
                                                 <?php
                                                }else{
                                               ?>
                                               ...
                                               <?php } 
                                                ...
                                                echo "<td><a href=\"add_quantity.php?product_id=$res[product_id]\">Add Qty</a> | <a href=\"product_update.php?product_id=$res[product_id]\">Edit</a> | <a href=\"product_delete.php?product_id=$res[product_id]
                                                \" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a> | <a href=\"admin_product_details.php?product_id=$res[product_id]\">View</a></td>";
                                              echo "</tr>"; 
                                            }
                                          }?>
                            </tbody>
