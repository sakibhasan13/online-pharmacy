    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="user_information.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active"><i
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5" id="product" role="tabpanel">
                    <h3 class="fs-4 mb-3">User Information</h3>
                    <?php
                                      include('../config/dbconn.php');
                                      ...
                                      $result = mysqli_query($connection,"SELECT * FROM `login` WHERE usertype='user' ORDER BY 'supp_name' ASC");
                                      ?>  
                    <div class="col">
