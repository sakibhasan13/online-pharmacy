...
<body>
    ...
    <div class="container-fluid px-4" style="width:80%;">
                ...
                <div class="row my-5" id="product" role="tabpanel">
                    <h3 class="fs-4 mb-3" style="text-align:center;padding-bottom:30px;text-transform:uppercase;">Blood Request</h3>
                    <?php
                                      include('../config/dbconn.php');
                                      $result = mysqli_query($connection,"SELECT * FROM `requester`");
                                      ?>  
                    <div class="col">
