<?php
    ...
    $insert_query = "INSERT INTO `login`(`name`, `email`, `username`, `phone`, `address`, `password`) VALUES ('$r_name','$r_email','$r_username', '$r_address', '$r_phone','$r_pass')";
    $duplicate_user = mysqli_query($connection,"SELECT * FROM `login` WHERE email = '$r_email'"); 
    ...
    if(!preg_match($mobilePattern,$r_phone)){
