...
<!-- ORDER NOW -->
 <section class="ordernow " id="product">
    ...
    <div class="order_cont">
        <div class="row1">
            <div class="order" id=order1 onclick="window.location.href='pages/product.php?category=covid'">Covid-19 Essentials</div>
            <div class="order" id=order2 onclick="window.location.href='pages/product.php?category=babycare'">Baby Care </div>
            <div class="order" id=order3 onclick="window.location.href='pages/product.php?category=nutrition'">Nutrition</div>
            <div class="order" id=order4 onclick="window.location.href='pages/product.php'">Himalaya</div>
        </div>
        <div class="row2">
        <div class="order" id=order5 onclick="window.location.href='pages/product.php?category=p_care'">Personal Care</div>
        <div class="order" id=order6 onclick="window.location.href='pages/product.php?category=ayurvedic'">Ayurvedic</div>
        <div class="order" id=order7 onclick="window.location.href='pages/product.php?category=skin_care'">Skin & Hair</div>
        <div class="order" id=order8 onclick="window.location.href='pages/product.php?category=human_m'">Human Wellness</div>
        </div>
...
<div class="scrolling-wrapper" id="service">
    <div onclick="window.location.href='pages/blood_index.php'" class="card">
           <img src="images/blood.jpg" alt="image">
      <h4>Blood Bank</h4>
    </div>
  </div>
